...
public class Celular {
	...
	@Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "celular_seq_generator")
    @SequenceGenerator(name = "celular_seq_generator", sequenceName = "CELULAR_SEQ", allocationSize = 1)
