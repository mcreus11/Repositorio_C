...
import com.mx.Mascotas.Service.MascotaService;
...
public class MascotaController {
    ...
    public ResponseEntity<Mascota> actualizarMascota(@PathVariable Long id, @RequestBody Mascota mascotaActualizada) {
        try {
            Mascota actualizada = mascotaService.actualizarMascota(id, mascotaActualizada);
    ...
    @GetMapping("/mascotas/todo/{id}")
    public ResponseEntity<?> listarTodo(@PathVariable long id){
        Map<String, Object> resultado = mascotaService.getModulos(id);
        return ResponseEntity.ok(resultado);
    }
    
    @GetMapping("/responsables/mascotas/{id}")
    public ResponseEntity<?> obtenerResponsableConMascotas(@PathVariable("id") Long idResponsable) {
        Map<String, Object> resultado = mascotaService.getResponsableConMascotas(idResponsable);
        return ResponseEntity.ok(resultado);
    }
